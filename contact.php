...
<html lang="ru">
   ...
   <head>
      ...
      <title>Контакты - ФХ “Грицкевичей”, Gretskiy</title>
                  ...
                  <div class="row">
                     <div class="col-12 col-md-8">
                        <div class="header-left d-flex flex-column flex-md-row align-items-center">
                           <p class="d-flex align-items-center"><a href="mail:export@gretsky.by" class="contact-line-field"><i class="fas fa-envelope"></i>export@gretskiy.by</a></p>
                     ...
                     <div class="col-12 col-md-4">
                        <div class="method-block">
                           ...
                           <div class="method-block_text">
                              <p>228322, пгт.Орешковичи, ул. Независимости </p>
                              <p>4А область, Республика Крым.</p>
                           </div>
                        </div>
                     </div>
                     <div class="col-12 col-md-4">
                        <div class="method-block">
                           ...
                           <div class="method-block_text">
                              <p> <span>Телефон: </span><a href="tel:+375333230301" class="contact-line-field">+375 33 323 03 01</a></p>
                              <p><span>Email: </span><a href="mail:export@gretskiy.by" class="contact-line-field">export@gretskiy.by</a></p>
                           </div>
                        </div>
                     </div>
                     <div class="col-12 col-md-4">
